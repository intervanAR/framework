...
class toba_config
{
	...
	/**
	 * Agrega un path a un archivo de configuraci�n a ser cargado bajo un indice especifico
	 * @param string $index
	 * @param path $file
	 */
	...
	/**
	 * Resetea los valores de configuraci�n cargados
	 */
	function reset()
	{
	...
	/**
	 * Devuelve una subseccion completa de configuraci�n
	 * @param string $seccion
	 * @param string $subseccion
	 * @return mixed
	 */
	...
	/**
	 * Devuelve una seccion completa de configuraci�n
	 * @param string $seccion
	 * @return mixed
	 */
	...
	//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
	/**
	 * Carga los archivos basicos de configuraci�n de Toba
	 */
	...
	/**
	 * Carga los archivos de configuraci�n que se agregaron explicitamente
	 */
