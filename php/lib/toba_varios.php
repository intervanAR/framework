<?php
	...
	*/
	...
	/**
	 * Si $var est� seteada la devuelve, sino devuelve el valor por defecto
	 * de la misma
	 * @param mixed $var
	 * @param mixed $default
	 * @return mixed
	 ...
	 * @param array $extensiones arreglo asociativo con 2 par�metros: el 1ro es
	 ...
	 * pasado por par�metro, se devuelve uno nuevo con las componentes vac�as
	 * eliminadas
	 * @param array $array
	 * @return array
	 */
	...
	/**
	 * Borra todos los subarrays vac�os de $array. Modifica la variable de entrada
	 * @param array $array
	 */
	...
	/**
	 * Si el par�metro no es un arreglo o es un arreglo sin la componente 0 mete
	 * el par�metro dentro de un arreglo
	 * @param mixed $elem
	 * @return array
	 */
	...
	//Toma una etiqueta e intenta extraer el caracter de acceso r�pido
	...
	/**
	 * Clase que otorga rangos para asignaci�n de tabs
	 * @package Varios
	 */
	...
	/**
	*	El objeto_de_mentira intenta superar su ejecuci�n sin causar ningun error ni warning
	...
	*/
	...
	function comparar($valor1, $operador, $valor2)
	{
		switch ($operador) {
			...
			default:
				throw new toba_error("El operador $operador no est� soportado");
		}
	}
