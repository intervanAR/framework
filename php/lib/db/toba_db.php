...
class toba_db
{
	 ...
	 * @param toba_parser_error_db $parser
	 */
	...
	*/
	...
	/**
	 * Marca el timestamp que indica el fin del log
	 * @ignore
	 */
	...
	*/
	 ...
	 * @param string $tabla
	 * @throws toba_error si no esta implementado
	 */
	...
	*/
	...
	/**
	 * Corta el string de una SQL cuando excede un limite de caracteres (util para el log)
	 * @param mixed $sql
	 * @return string
	 * @ignore
	 */
