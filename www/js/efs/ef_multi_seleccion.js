...
ef_multi_seleccion.prototype.constructor = ef_multi_seleccion;
	...
	/**
	 * @class Elemento que permite la selecci�n de varios valores. Clase base abstracta
	 * @constructor
	...
	ef_multi_seleccion.prototype.validar = function() {
		...
		if (this._limites[1] !== null) {
			if (valores.length > this._limites[1]) {
				...
				this._error = "no puede tener m�s de " + elemento + " seleccionados.";
				return false;	
			}
		}
		return true;
	...
	/**
	 * Retorna verdadero si el ef tiene alg�n valor cargado
	 * @type boolean
	 */	
...
ef_multi_seleccion_lista.constructor = ef_multi_seleccion_lista;
	...
	/**
	 * @class Permite la selecci�n de varios valores a partir de una lista. Equivale al tag <em>select multiple</em> en HTML
	 * @constructor
	...
	/**
	 * Selecciona todos o ning�n los elementos de la lista
...
ef_multi_seleccion_check.constructor = ef_multi_seleccion_check;
	...
	/**
	 * @class Permite la selecci�n de varios valores a partir de un conjunto de checkboxes
	 * @constructor
...
ef_multi_seleccion_doble.constructor = ef_multi_seleccion_doble;	
	...
	/**
	 * @class Permite la selecci�n de varios valores a partir de una lista doble, pasando los elementos de un lado hacia el otro
	 * @constructor
